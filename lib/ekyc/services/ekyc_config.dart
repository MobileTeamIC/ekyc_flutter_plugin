...
// MARK: - CÁC THUỘC TÍNH VỀ KHUÔN MẶT
  ...
  final int? contentColorHeaderBar;
  final int? backgroundColorHeaderBar;
  final int? textColorContentMain;
  final int? titleColorMain;
  final int? backgroundColorMainScreen;
  final int? backgroundColorLine;
  final int? backgroundColorActiveButton;
  final int? backgroundColorDeactiveButton;
  final int? titleColorActiveButton;
  final int? titleColorDeactiveButton;
  final int? backgroundColorCaptureDocumentScreen;
  final int? backgroundColorCaptureFaceScreen;
  final int? effectColorNoticeFace;
  final int? textColorNoticeFace;
  final int? effectColorNoticeInvalidFace;
  final int? colorContentFaceEffect;
  final int? effectColorNoticeValidDocument;
  final int? effectColorNoticeInvalidDocument;
  final int? textColorNoticeValidDocument;
  final int? textColorNoticeInvalidDocument;
  final int? tintColorButtonCapture;
  final int? backgroundColorBorderCaptureFace;
  ...
  final int? backgroundColorPopup;
  final int? textColorContentPopup;
