...
SWIFT_CLASS("_TtC9ICSdkEKYC32CompatibleDictionaryTextProvider")
...
SWIFT_CLASS("_TtC9ICSdkEKYC15EmulatorChecker")
@interface EmulatorChecker : NSObject
+ (BOOL)amIRunInEmulator SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9ICSdkEKYC14ICEkycConstant")
@interface ICEkycConstant : NSObject
...
SWIFT_CLASS("_TtC9ICSdkEKYC12ICEkycCrypto") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface ICEkycCrypto : NSObject
...
+ (NSData * _Nonnull)sha256Data:(NSString * _Nonnull)input SWIFT_WARN_UNUSED_RESULT;
+ (NSData * _Nonnull)sha256DataNonce:(NSString * _Nonnull)input SWIFT_WARN_UNUSED_RESULT;
+ (NSData * _Nullable)pemToDer:(NSString * _Nonnull)pem SWIFT_WARN_UNUSED_RESULT;
+ (SecKeyRef _Nullable)loadPublicKeyFrom:(NSData * _Nonnull)derData SWIFT_WARN_UNUSED_RESULT;
+ (SecKeyRef _Nullable)loadPrivateKeyFrom:(NSData * _Nonnull)derData SWIFT_WARN_UNUSED_RESULT;
+ (NSData * _Nullable)encryptWithRSAOAEPWithMessage:(NSData * _Nonnull)message pemPublicKey:(NSString * _Nonnull)pemPublicKey SWIFT_WARN_UNUSED_RESULT;
+ (NSData * _Nullable)decryptWithRSAOAEPWithCipherText:(NSData * _Nonnull)cipherText pemPrivateKey:(NSString * _Nonnull)pemPrivateKey SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nullable)encryptChaCha20Poly1305WithPlaintext:(NSString * _Nonnull)plaintext keyData:(NSData * _Nonnull)keyData nonceData:(NSData * _Nonnull)nonceData SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC9ICSdkEKYC16JailbreakChecker")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC9ICSdkEKYC20LottieAnimationLayer")
...
SWIFT_CLASS("_TtC9ICSdkEKYC23LottieAnimationViewBase")
...
/// </ul>
IB_DESIGNABLE
SWIFT_CLASS("_TtC9ICSdkEKYC19LottieAnimationView")
...
@interface NSString (SWIFT_EXTENSION(ICSdkEKYC))
- (NSString * _Nonnull)toLowerCase SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)removeExtraSpaces SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)removeVietnameseDiacritics SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)qrScanningHooked;
@end

@interface UIImage (SWIFT_EXTENSION(ICSdkEKYC))
- (void)readQRCodeWithCompletion:(void (^ _Nonnull)(NSString * _Nullable))completion;
@end

@interface UIImage (SWIFT_EXTENSION(ICSdkEKYC))
- (NSData * _Nullable)addMetaDataWithPath:(NSURL * _Nonnull)path make:(NSString * _Nonnull)make SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nullable)addMetaDataWithData:(NSData * _Nonnull)data make:(NSString * _Nonnull)make SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nonnull)removeExifDataWithData:(NSData * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
- (UIImage * _Nullable)rotateWithRadians:(float)radians SWIFT_WARN_UNUSED_RESULT;
@end

@class UILabel;
@interface UITapGestureRecognizer (SWIFT_EXTENSION(ICSdkEKYC))
- (BOOL)didTapGestureRecognizerAttributedTextInLabelWithLabel:(UILabel * _Nonnull)label inRange:(NSRange)targetRange SWIFT_WARN_UNUSED_RESULT;
@end
